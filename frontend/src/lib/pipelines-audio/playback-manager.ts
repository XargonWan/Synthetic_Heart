// Ported from Project AIRI packages/pipelines-audio/src/managers/playback-manager.ts
// (https://github.com/moeru-ai/airi, MIT). See frontend/NOTICE.md.
// Changes: types inlined from ../types.ts; @moeru/std errorMessageFrom inlined.
...
export type PlaybackManager<TAudio> = ReturnType<typeof createPlaybackManager<TAudio>>
