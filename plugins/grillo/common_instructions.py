...
OBSERVER_PROACTIVE_INSTRUCTIONS = (
    ...
    "- Put the routing path in the action payload as 'interface_path' and, when a message is warranted, use the matching message_* action type (e.g. 'message_telegram_bot').\n"
