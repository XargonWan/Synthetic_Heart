...
class GrilloPlugin(AIPluginBase):
    ...
    async def _create_self_reflection_prompt(self) -> str:
        return (
            ...
            "This is an INTERNAL introspection beat. Check in with yourself and record a concise reflection.\n\n"
            "IMPORTANT: This is internal processing - do NOT output any message_* actions.\n"
            "Only output a create_personal_diary_entry action with your reflection.\n\n"
            "Respond ONLY with valid JSON:\n"
            '{"actions": [{"type": "create_personal_diary_entry", "payload": {"interaction_summary": "Internal self-reflection", "personal_thought": "your reflection here"}}]}'
        )
    ...
    async def _create_curiosity_prompt(self) -> str:
        ...
        intro += "This is an INTERNAL introspection beat. Do NOT output any message_* actions.\n\n"
        if history_snippet:
            intro += (
        ...
        intro += (
            ...
            "Respond ONLY with a create_personal_diary_entry action (no message actions):\n"
            '{"actions": [{"type": "create_personal_diary_entry", "payload": {"interaction_summary": "Curiosity exploration", "personal_thought": "your curious thoughts"}}]}'
        )
        return intro
