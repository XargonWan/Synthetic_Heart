...
def get_local_timezone() -> ZoneInfo:
    ...
    # Fallback: If config is "UTC" (default) but env var has a different value, use env.
    # This covers cases where config registry hasn't loaded env overrides yet.
    env_tz = os.getenv("TZ")
...
def utc_to_local(dt: datetime) -> datetime:
    ...
    # Ensure dt is timezone-aware (assume UTC if naive, as commonly returned by datetime.utcnow())
