...
def test_send_animation_includes_reset_eyes(monkeypatch):
    ...
    async def run():
        await ah._send_animation_command(session_id=None, animation_file='Thinking.fbx', loop=True, state='think', descriptor={'fps':30}, play_section=None, priority=None, source=None)
