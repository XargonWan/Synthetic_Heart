...
from core.chat_archives_db import create_archive, list_archives, load_archive, delete_archive


@pytest.mark.asyncio
async def test_db_archive_create_list_load_delete():
    messages = [
        {"sender_name": "user", "sender_id": "abc123", "text": "Hello DB!", "timestamp": "2025-01-01T00:00:00Z", "interface_path": "synth_webui/test"},
    ]
    meta = {"camera": {"x": 0}}
    # Create
