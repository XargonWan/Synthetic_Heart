...
def test_no_subtitle_in_templates():
    ...
    tpl_index = Path('core/webui_templates/synth_webui_shell.html').read_text(encoding='utf-8')
...
def test_manifest_and_icons_present():
    from pathlib import Path
    tpl = Path('core/webui_templates/synth_webui_shell.html').read_text(encoding='utf-8')
