...
def test_ui_helpers_has_no_export():
    ...
    assert 'export {' not in text, "ui-helpers.js should not use ES module exports in non-module script" 
...
def test_phase_priorities_terminated():
    ...
    assert '};' in snippet, "PHASE_PRIORITIES declaration appears to be malformed (missing '};')"
