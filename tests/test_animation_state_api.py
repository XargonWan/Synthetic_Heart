...
def test_set_animation_state_calls_handler():
    ...
    ui = client.app.state._app  # FastAPI TestClient wiring: access underlying app via client
    ...
    r = test_client.post('/api/animation_state', json={'state': 'think', 'session_id': 's123', 'loop': True})
