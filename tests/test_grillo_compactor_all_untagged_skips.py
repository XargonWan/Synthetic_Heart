...
async def test_all_untagged_batch_skipped(monkeypatch):
    ...
    class DummyCursor:
        ...
        async def fetchall(self):
            return [
                {"id": 901, "content": "Legacy A", "tags": None, "timestamp": "2020-01-01"},
                {"id": 902, "content": "Legacy B", "tags": None, "timestamp": "2020-01-02"},
            ]
    ...
    assert res is False
    assert any('No tagged candidate memories in this batch; skipping compaction' in m for m in logged)
