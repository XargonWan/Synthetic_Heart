...
async def test_preflight_timeout(monkeypatch):
    ...
    async def slow_llm_preflight(*, text: str, interface_name: str | None, original_message, max_results: int):
        await asyncio.sleep(2)
        return ["This should not be included"]

    monkeypatch.setattr('core.prompt_engine.llm_memory_search_preflight', slow_llm_preflight)
