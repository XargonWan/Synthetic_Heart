...
def test_gemini_ui_reset_opens_new_chat_and_returns_retry(monkeypatch):
    ...
    monkeypatch.setattr(s, '_send_prompt_with_confirmation', lambda textarea, prompt_text, **kwargs: True)
    ...
    monkeypatch.setattr(s, 'wait_until_response_stabilizes', lambda driver, **kwargs: "Non sono a mio agio con questa conversazione, meglio interromperla.")
    ...
    res = s._engine_ui_reset_hook(previous_response="Non sono a mio agio con questa conversazione, meglio interromperla.")
