...
This project is indexed by GitNexus as **Synthetic_Heart** (9633 symbols, 30993 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
